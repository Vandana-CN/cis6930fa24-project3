import pytest
from project3.extractdata import extractdata, extract_time, extract_address
from project3.extractdata import extract_nature_and_ori, extract_number
...
def test_extract_nature_and_ori(sample_incident_string):
    ...
    nature, ori = extract_nature_and_ori(sample_incident_string)
...
def test_extract_address(sample_incident_string):
    ...
    address = extract_address(sample_incident_string)
