import os
import pytest
from project3.getincidents import getincidents

@pytest.fixture
def sample_pdf_url():
    '''Provides a constant sample url to test downloading the data'''
    return "https://www.normanok.gov/sites/default/files/documents/2024-08/2024-08-01_daily_incident_summary.pdf"
...
def test_fetchincidents_success(sample_pdf_url):
    ...
    data = getincidents(sample_pdf_url)
